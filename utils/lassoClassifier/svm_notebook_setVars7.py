...
def svm_notebook_setVars7(mousename, imagingFolder, mdfFileNumber, minTrPerChoice=15, earliestGoTone=50, numSamples=50, nRandCorrSel=50, trialHistAnalysis=0, iTiFlg=2):
