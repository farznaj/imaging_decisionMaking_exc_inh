...
if trialHistAnalysis:
    ...
    if doData and doShuffles==0:
        svmn = 'svmCurrChoice_allN_allFrsTrained_data_ds%d_%s_' %(regressBins,nowStr)
    elif doData==0 and doShuffles:
        svmn = 'svmCurrChoice_allN_allFrsTrained_shfl_ds%d_%s_' %(regressBins,nowStr)
    else:
        svmn = 'svmCurrChoice_allN_allFrsTrained_ds%d_%s_' %(regressBins,nowStr)
