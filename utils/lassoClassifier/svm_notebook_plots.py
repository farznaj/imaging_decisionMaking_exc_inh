...
#%% You think you should not do this... bc days w all-0 weights are days that no decoder was found for them, so it means they don't carry choice info... 
''' 
##############################################################################################   
########### Find days with all-0 weights for all rounds and exclude them ##########################     
########### Also find days with few rounds with non-zero wei"ghts (these are outlier days) ##############
####################################################################################################               
'''
