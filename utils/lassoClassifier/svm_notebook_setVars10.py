# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 18:44:26 2017
...
def svm_notebook_setVars10(mousename, imagingFolder, mdfFileNumber, ch_st_goAl, doInhAllexcEqexc, numSamples=50, numShufflesExc=50, trialHistAnalysis=0, iTiFlg=2):
...
#    execfile("svm_decodeStimCateg.py")
    execfile("svm_diffNumNeurons_eachFrame.py")
