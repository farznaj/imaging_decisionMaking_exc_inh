...
%%
kpdo = 1;
maxIter = 100; % start w 100, if cost of common slope model is more than regress model, increase it to 1000.
...
while kpdo
    ...
    if cost_common > f1
        warning('Regress model has lower cost that common-slope model. Increasing maxIter to 1000')
        maxIter = 1000;
    else
        kpdo = 0;
    end
