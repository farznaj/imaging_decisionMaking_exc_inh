...
rmv_timeGoTone_if_stimOffset_aft_goTone = 1;
...
alignedEvent = 'goTone';% options: 'initTone', 'stimOn', 'goTone', '1stSideTry', 'reward', 'commitIncorrResp';
...
plot(Ix, 0, 'ko', 'markerfacecolor', 'g');
title(['P-value ' num2str(pVal)]);
legend('chance distribution', 'data')
xlabel('alignment index')
ylabel('count')
