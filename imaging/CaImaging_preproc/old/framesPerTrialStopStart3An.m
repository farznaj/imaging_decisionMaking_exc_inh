...
if length(trialNumbers) > nTrials
  error('framesPerTrialStopStart3An:missingStarts', 'Missing %d trial starts', ...
...
for tr = 1:nTrials
  ...
  frame1RelToStartOff(tr) = -(startOffSamples(tr) - startOnSamples(tr));
end
