...
if isfield(alldata(23).parsedEvents.states, 'punish_allowcorrection')
    ...
    fprintf('No punishAllowCorrectionState... weird!\n')
end
...
if isfield(alldata(23).parsedEvents.states, 'errorlick_again_wait')
    ...
    fprintf('No errorlick_again_wait state... weird!\n')
end
