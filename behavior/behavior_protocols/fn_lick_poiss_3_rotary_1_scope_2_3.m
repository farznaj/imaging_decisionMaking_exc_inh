% Version comparison: 2_3 vs. 2_2: % I got rid of the state lickcenter_again. 
% After wait_stim the animal goes directly to state center_reward, which lasts 1E-6. 
% As a result no center water is delivred and the animal is not anymore required to do 
% center lick again in order to receive the go tone.
% (written on 151209)
